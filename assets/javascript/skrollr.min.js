...
(function(e, t, r) {
    "use strict";
    function n(r) {
        if (o = t.documentElement, a = t.body, O()
            , j = this, r = r || {}, K = r.constants || {}, r.easing)for (var n in r.easing)
            V[n] = r.easing[n];
        if (Y = {
            ...
            var i = t.getElementById("skrollr-body") || t.createElement("div"), s = i.style;
            s.minWidth = "1px", s.position = "absolute", s.top = s.zIndex = "0", i.id || (s.width = "1px", s.right = "0", a.appendChild(i)), function(e) {
                tt = function() {
                    e.apply(this, arguments), s.height = ft + o.clientHeight + "px"
                }
            }(tt)
        }
        return j.refresh(), l.addEvent(e, "resize", tt), function f() {
            S(f), N()
        }(), j
    }
    var o, a, l = e.skrollr = {
        ...
        VERSION: "0.5.14"
    }, i = Object.prototype.hasOwnProperty, s = "rendered", f = "un" + s, c = "skrollable", u = "skrollr", p = "no-" + u, m = "linear", d = 1e3, g = 200, h = "start", v = "end", T = "center", y = "bottom", b = "___has_rendered_class", k = "___skrollable_id", S = e.requestAnimationFrame;
    (function() {
        var t, r = ["ms", "moz", "webkit", "o"];
        for (t = 0; r.length > t&&!S; t++)
            S = e[r[t] + "RequestAnimationFrame"];
        var n = 0;
        S || (S = function(t) {
            var r = it(), o = Math.max(0, 30 - (r - n));
            e.setTimeout(function() {
                t(r + o)
            }, o), n = r + o
        })
    })();
    var w, x, E = /^\s+|\s+$/g, F = /^data(?:-(_\w+))?(?:-?(-?\d+))?(?:-?(start|end|top|center|bottom))?(?:-?(top|center|bottom))?$/, z = /\s*([a-z\-\[\]]+)\s*:\s*(.+?)\s*(?:;|$)/gi, A = /^([a-z\-]+)\[(\w+)\]$/, M = /-([a-z])/g, _ = function(e, t) {
        return t.toUpperCase()
    }, D = /[\-+]?[\d]*\.?[\d]+/g, H = /\{\?\}/g, C = /rgba?\(\s*-?\d+\s*,\s*-?\d+\s*,\s*-?\d+/g, I = /[a-z\-]+-gradient/g, O = function() {
        var t = /^(?:O|Moz|webkit|ms)|(?:-(?:o|moz|webkit|ms)-)/;
        if (e.getComputedStyle) {
            var r = e.getComputedStyle(a, null);
            for (var n in r)
                if (w = n.match(t)||+n == n && r[n].match(t))
                    break;
    ...
    n.prototype.refresh = function(e) {
        ...
        var n = o.clientHeight, a = e.getBoundingClientRect(), l = a.top, i = a.bottom - a.top;
        return t === y ? l -= n : t === T && (l -= n / 2), r === y ? l += i : r === T && (l += i / 2), l += j.getScrollTop(), 0 | l + .5
    }, n.prototype.animateTo = function(e, t) {
        t = t || {};
        var n = it(), o = j.getScrollTop();
        return Q = {
            startTop: o,
            topDiff: e - o,
            targetTop: e,
    ...
    var q = function() {
        ...
        for (a = 0; W.length > a; a++)
            for (e = W[a], t = e.element, r = e.anchorTarget, n = e.keyFrames, l = 0; n.length > l; l++)
                o = n[l], "relative" === o.mode && (i = t.style.cssText, s = nt(t), t.style.cssText = e.styleAttr, ot(t, e.classAttr), o.frame = j.relativeToAbsolute(r, o.anchors[0], o.anchors[1]) - o.offset, t.style.cssText = i, ot(t, s)), J&&!o.isEnd && o.frame > ft && (ft = o.frame);
        for (ft = Math.max(ft, rt()), a = 0; W.length > a; a++)
            for (e = W[a], n = e.keyFrames, l = 0; n.length > l; l++)
                o = n[l], o.isEnd && (o.frame = ft - o.offset)
    }, G = function(e, t) {
        for (var r = 0; W.length > r; r++) {
            var n, o, a = W[r], c = a.smoothScrolling ? e: t, u = a.keyFrames, p = u[0].frame, m = u[u.length-1].frame, d = p >= c, g = c >= m;
            if (d || g) {
                var h = u[d ? 0: u.length-1].props;
                for (n in h)
                    i.call(h, n) && (o = P(h[n].value), l.setStyle(a.element, n, o));
        ...
        var e, t, n = j.getScrollTop(), o = it();
        if (Q)
            o >= Q.endTime ? (n = Q.targetTop, e = Q.done, Q = r) : (t = Q.easing((o - Q.startTime) / Q.duration), n = 0 | Q.startTop + t * Q.topDiff), j.setScrollTop(n);
        else {
            var a = Z.targetTop - n;
            a && (Z = {
                startTop: pt,
        ...
        for (var t = 0; e.keyFrames.length > t; t++) {
            for (var r, n, o, a, l = e.keyFrames[t], i = {}; null !== (a = z.exec(l.props));)
                o = a[1], n = a[2], r = o.match(A), null !== r ? (o = r[1], r = r[2]) : r = m, n = n.indexOf("!") ? B(n) : [n.slice(1)], i[o] = {
                value: n,
                easing: V[r]
            };
            l.props = i
        ...
        var t, r = {};
        for (t = 0; e.keyFrames.length > t; t++)
            R(e.keyFrames[t], r);
        ...
        var r;
        for (r in t)
            i.call(e.props, r) || (e.props[r] = t[r]);
        for (r in e.props)
            t[r] = e.props[r]
    }, U = function(e, t, r) {
        if (e.length !== t.length)
            throw "Can't interpolate between \"" + e[0] + '" and "' + t[0] + '"';
        for (var n = [e[0]], o = 1; e.length > o; o++)
            n[o] = e[o] + (t[o] - e[o]) * r;
        return n
    }, P = function(e) {
        var t = 1;
    ...
    l.setStyle = function(e, t, r) {
        var n = e.style;
        if (t = t.replace(M, _).replace("-", ""), "zIndex" === t)
            n[t] = "" + (0 | r);
        else if ("float" === t)
    ...
    var j, W, Y, J, K, Q, X, Z, et, tt = function() {
        ...
        if (e.SVGElement && t instanceof e.SVGElement && (t = t[a], a = "baseVal"), o === r)
            return t[a] = n, r;
        for (var l = t[a], i = 0; n.length > i; i++)
            -1 === lt(l).indexOf(lt(n[i])) && (l += " " + n[i]);
        for (var s = 0; o.length > s; s++)
            l = lt(l).replace(lt(o[s]), " ");
        t[a] = at(l)
    }, at = function(e) {
        return e.replace(E, "")
    }, lt = function(e) {
    ...
    }, ft = 0, ct = 1, ut = "down", pt =- 1, mt = it(), dt = 0
})(window, document);
